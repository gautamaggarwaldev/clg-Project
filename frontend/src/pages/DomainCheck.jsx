      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            Analyze any domain for security threats, malware, and reputation data
          </p>
        </motion.div>
              ...
              <div className="p-6 md:p-8">
                ...
                >
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${getRiskColor(calculateRisk(report.stats)).replace("bg-gradient-to-r", "bg")}`}>
                  ...
                  <div className="w-full bg-gray-700 rounded-full h-4 overflow-hidden">
                    <motion.div
                      ...
                      className={`h-full rounded-full ${getRiskColor(calculateRisk(report.stats))}`}
                    />
                  </div>
                </motion.div>
                ...
                >
                  <h3 className="text-xl font-semibold mb-4 text-cyan-300">Domain Information</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <span className="font-medium">{report.reputation}</span>
                      </div>
                      <div>
                        <span className="text-gray-400">TLD:</span>{" "}
                        <span className="font-medium">{report.tld}</span>
                      </div>
                    </div>
                  </div>
                </motion.div>
                        ...
                        <div className="overflow-x-auto">
                          <table className="min-w-full divide-y divide-gray-700">
                            <thead className="bg-gray-700">
                              <tr>
                                <th className="px-4 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Engine</th>
                            ...
                            <tbody className="bg-gray-800 divide-y divide-gray-700">
                              {Object.entries(report.results || {}).map(
                                ([engine, info]) => (
                                  <tr key={engine} className="hover:bg-gray-700 transition-colors">
                                    <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-100">{engine}</td>
