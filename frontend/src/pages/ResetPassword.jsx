...
const ResetPassword = () => {
  ...
  const handleReset = async (e) => {
    ...
    try {
      ...
      await axios.post(`https://cs-qhmx.onrender.com/v1/user/reset-password/${token}`, {
        newPassword,
        confirmPassword,
      });
          ...
          >
            ...
            <motion.button
              ...
              className={`w-full py-3 rounded-xl font-medium text-white transition-all duration-300 ${
                loading ? 'bg-cyan-700' : 'bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700'
              }`}
              whileTap={{ scale: 0.98 }}
